				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="text" required class="login__input" id="login-email"
							placeholder=" " name="name"> <label for="login-email"
							class="login__label">Name</label>
					</div>
				</div>
				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="email" required class="login__input" id="login-email"
							placeholder=" " name="email"> <label for="login-email"
				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="tel" required class="login__input" id="login-email"
							placeholder=" " name="phone"> <label for="login-email"
							class="login__label">Phone</label>
					</div>
				</div>
				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="text" required class="login__input"
							id="login-email" placeholder=" " name="address"> <label
							for="login-email" class="login__label">Address</label>
					</div>
				</div>
				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="password" required class="login__input"
							id="login-pass" placeholder=" " name="password"> <label for="login-pass"
